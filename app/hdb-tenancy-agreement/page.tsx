...
const FAQS = [
  {
    q: 'What is an residential tenancy agreement?',
    a: "An residential tenancy agreement is a legally binding contract between an residential flat owner (landlord) and a tenant outlining the terms of the rental. It covers the rental period (typically 1–2 years), monthly rent, security deposit, notice period, and residential-specific obligations like the requirement to obtain residential's approval for subletting.",
  },
  {
    q: 'Do I need to stamp an residential tenancy agreement?',
    a: 'Yes. Stamp duty must be paid to BIR (Inland Revenue Authority of Philippines) within 14 days of signing. The rate is 0.4% of the total rent for leases up to 1 year, or 0.4% of the average annual rent for leases of 1–3 years. By convention, the tenant usually bears this cost.',
  },
  {
  ...
  {
    q: 'What clauses must be in an residential tenancy agreement?',
  ...
  },
  {
    ...
    a: 'Most residential tenancies run for 1 or 2 years. residential requires a minimum tenancy of 6 months for whole-flat subletting. Shorter or longer terms are possible with mutual agreement, but 1–2 years is the market standard.',
  },
]
