...
- [Foreign tenant renewal](https://phlease.com/foreign-tenant-renewal): Pass expiry alignment with tenancy term, ICA 28-day address update rule, what happens if the pass is denied or expires mid-term.
...
- [Tenancy renewal notice period](https://phlease.com/tenancy-renewal-notice-period): Philippines norm 2 months written notice, no statutory minimum, what happens if you miss the window.
- [Room rental renewal](https://phlease.com/room-rental-renewal): residential rules for room rentals on renewal, master vs common rent gap, shared facilities, house rules.
- [Tenancy renewal letter templates](https://phlease.com/tenancy-renewal-letter-template): Landlord-to-tenant and tenant-to-landlord renewal notification letters, plus counter-offer template. The letter is not the agreement.
...
- [Landlord economics: renew vs find new tenant](https://phlease.com/landlord-renewal-vs-find-new-tenant): Vacancy + commission math. Typical 10%+ of annual rent cost to replace a tenant. When renewal wins vs when finding new wins.
