...
const HOMEPAGE_FAQS = [
  {
    ...
    a: 'Use PhLease to generate a tenancy agreement online. Select your property type (condo, apartment, house & lot, or room rental), enter property details, landlord and tenant information, rental terms, and optional clauses. Preview the full agreement for free, then download the PDF from ₱500.',
  },
  {
    q: 'What should be included in a tenancy agreement?',
    a: 'A tenancy agreement should include the property address, landlord and tenant details (names, valid government ID), rental amount, tenancy period, security deposit, notice period, and any special clauses such as a diplomatic clause or pet policy.',
  },
  {
    q: 'Is a tenancy agreement legally required in Philippines?',
    a: 'While not strictly required by law for all rentals, a written tenancy agreement is strongly recommended and practically essential. It protects both landlord and tenant, and must be stamped with BIR within 5 days after the end of the month of signing to be admissible as evidence in court.',
  },
  {
  ...
  {
    q: 'Can I rent out a room without a tenancy agreement?',
    a: 'Technically you can, but it is not advisable. A tenancy agreement protects both parties and clearly sets out the rental terms, deposit, and notice period. A written agreement is strongly recommended for room rentals too.',
  },
  {
    q: 'What is the minimum rental period for rooms in Philippines?',
    a: 'For whole-unit leases, the standard rental period is 1 year. For individual room rentals within an owner-occupied unit, there is no official minimum period, but most landlords require at least 3–6 months.',
  },
]
    ...
    itemListElement: [
      {
        ...
        description: 'Condo, apartment, house & lot, or room rental — guided 5-minute form, BIR stamp duty ready.',
        price: '10',
        priceCurrency: 'PHP',
