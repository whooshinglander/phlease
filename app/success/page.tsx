      ...
      .then(data => {
        if (data.paid) {
          ...
          if (typeof window !== 'undefined' && typeof uetq === 'function') {
            uetq('push', { ec: 'ecommerce', ea: 'purchase', el: 'phlease', ev: data.amount_total ? data.amount_total / 100 : 500, gv: data.amount_total ? data.amount_total / 100 : 500, gc: (data.currency || 'usd').toUpperCase(), to: sessionId })
          }
        } else {
