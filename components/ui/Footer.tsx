    ...
    <footer className="border-t border-slate-200/60 bg-white mt-16">
      <div className="container-narrow py-10">
        ...
        <div className="flex flex-wrap justify-center gap-x-5 gap-y-2 mb-6">
          ...
          <Link href="/renew" className="text-sm text-navy-500 hover:text-brand-700 transition-colors font-medium">Renew</Link>
          <Link href="/blog" className="text-sm text-navy-500 hover:text-brand-700 transition-colors font-medium">Guides</Link>
          <Link href="/about" className="text-sm text-navy-500 hover:text-brand-700 transition-colors font-medium">About</Link>
